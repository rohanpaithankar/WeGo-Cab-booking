...
CREATE TABLE `assigned` (
  ...
  KEY `assfk2` (`booking_id`),
  KEY `assfk1` (`dri_id`),
  CONSTRAINT `assfk1` FOREIGN KEY (`dri_id`) REFERENCES `driver` (`dri_id`) ON DELETE CASCADE,
  CONSTRAINT `assfk2` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`booking_id`) ON DELETE CASCADE
